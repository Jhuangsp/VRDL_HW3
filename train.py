...
# T2 python train.py --cfg cfg\\mydata.cfg --data data\\train_list.data --img-size 160 --epoch 30 --batch-size 256 --adam
# T3 python train.py --cfg cfg\\mydata.cfg --data data\\train_list.data --img-size 160 --epoch 30 --batch-size 256 --adam
# T4 python train.py --cfg cfg\\mydata-spp.cfg --data data\\train_list.data --img-size 160 --epoch 20 --batch-size 64 --adam
# T5 python train.py --cfg cfg\\mydata-spp.cfg --data data\\train_list.data --img-size 160 --epoch 50 --batch-size 64 --adam
# T6 python train.py --cfg cfg\\mydata-spp.cfg --data data\\train_list.data --img-size 64 --epoch 50 --batch-size 256 --adam
# T7 python train.py --cfg cfg\\mydata-spp.cfg --data data\\train_list.data --epoch 50 --batch-size 32 --adam --weights pre-train\\darknet53.conv.74
# T8 python train.py --cfg cfg\\myyolov3.cfg --data data\\train_list.data --epoch 50 --batch-size 32 --adam --weights pre-train\\darknet53.conv.74
# T9 python train.py --cfg cfg/myyolov3.cfg --data data/all.data --epoch 30 --weights pre-train/darknet53.conv.74