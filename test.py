...
# python test.py --data data/train_list.data --cfg cfg/mydata.cfg --img-size 320 --weights weights/last.pt --conf-thres 0.4
# T2 python test.py --data data/train_list.data --cfg cfg/mydata.cfg --img-size 160 --weights weights/best.pt --conf-thres 0.5
# T3 python test.py --data data/train_list.data --cfg cfg/mydata.cfg --img-size 160 --weights weights/best.pt --conf-thres 0.5
