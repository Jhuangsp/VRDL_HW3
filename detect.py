...
# T4 python test.py --data data/train_list.data --cfg cfg/mydata-spp.cfg --img-size 160 --weights weights/best.pt --conf-thres 0.5
# T5 python detect.py --data data/train_list.data --cfg cfg/mydata-spp.cfg --img-size 160 --weights weights/best.pt --conf-thres 0.5
# T6 python detect.py --data data/train_list.data --cfg cfg/mydata-spp.cfg --img-size 64 --weights weights/best.pt --conf-thres 0.5
# T7 python detect.py --cfg cfg\\mydata-spp.cfg --data data\\train_list.data --weights weights/best.pt --conf-thres 0.5
# T8 python detect.py --cfg cfg/myyolov3.cfg --data data/train_list.data --weights weights/best.pt --conf-thres 0.5
# T9 python detect.py --cfg cfg/myyolov3.cfg --data data/all.data --weights weights/last.pt --conf-thres 0.5
